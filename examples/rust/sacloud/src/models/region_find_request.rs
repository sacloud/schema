...
pub struct RegionFindRequest {
    ...
    pub filter: Option<crate::models::RegionFindFilter>,
}

impl RegionFindRequest {
    pub fn new() -> RegionFindRequest {
        RegionFindRequest {
            count: None,
            exclude: None,
            from: None,
...
impl fmt::Display for RegionFindRequest {
